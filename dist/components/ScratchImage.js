...
var _scratchTopImage = _interopRequireDefault(require("./scratch-top-image.jpg"));
...
class ScratchImage extends _react.default.PureComponent {
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: this.props.outerImageWH ? this.props.outerImageWH : 'outer-image'
    }, /*#__PURE__*/_react.default.createElement("canvas", {
      ref: el => this.canvas = el
    })), /*#__PURE__*/_react.default.createElement("div", {
      className: 'inner-image'
    }, /*#__PURE__*/_react.default.createElement("img", {
      src: this.props.innerImage ? this.props.innerImage : _voucher.default,
      alt: "x",
      className: this.props.innerImageWH ? this.props.innerImageWH : 'inner-image-wh'
    }))), /*#__PURE__*/_react.default.createElement("div", {
      style: {
        marginTop: '1rem'
      }
    }, this.state && this.state.displayConfirm && this.props.showResetText ? /*#__PURE__*/_react.default.createElement("button", {
      className: this.props.resetBtn,
      onClick: this.reset
    }, this.props.resetText ? this.props.resetText : 'Reset') : null, this.state && this.state.displayConfirm && this.props.showConfirmText ? /*#__PURE__*/_react.default.createElement("button", {
      className: this.props.confirmBtn,
      style: {
        marginLeft: '1rem'
      },
      onClick: () => this.doneScratch
    }, this.props.confirmText ? this.props.confirmText : 'Confirm') : null));
  }
